...
use crate::chroma::transport::send_feature_report;
...
impl ChromaHandle {
    ...
    fn query_battery_inner(
        ...
        let battery_resp = match send_feature_report(device, &battery_req) {
            Ok(resp) => resp,
        ...
        let charging = match send_feature_report(device, &charging_req) {
